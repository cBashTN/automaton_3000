...
namespace Automaton_3000ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"..\..\..\..\ExtractFeatures\bin\Debug\net5.0\Output\crew.csv";
        ...
        public static void ShowFeatureImportanceAndWeights()
        {
            ...
            var trainer = mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options() { NumberOfLeaves = 7, MinimumExampleCountPerLeaf = 1, NumberOfTrees = 500, LearningRate = 0.07587501f, Shrinkage = 2.60485f, LabelColumnName = "Label", FeatureColumnName = "Features" });
